        ...
        switch (await checkConnection(), process.argv[2]) {
            ...
            case '-u':
                try {
                    ...
                    if (logger('L\u1EA5y d\u1EEF li\u1EC7u th\xE0nh c\xF4ng !', 'MeewMeew'), 0 == Object.keys(c.commands).length && 0 == Object.keys(c.events).length) return logger('B\u1EA1n hi\u1EC7n \u0111ang s\u1EED d\u1EE5ng t\u1EA5t c\u1EA3 module \u1EDF phi\xEAn b\u1EA3n m\u1EDBi nh\u1EA5t !', 'MeewMeew'), void 0;
                    logger('Ti\u1EBFn h\xE0nh c\u1EADp nh\u1EADt c\xE1c module:', 'MeewMeew'), await details(c), logger('B\u1EAFt \u0111\u1EA7u c\u1EADp nh\u1EADt c\xE1c module c\u1EE7a Mew..', 'MeewMeew'), await loadUpdate(c, b), logger('C\u1EADp nh\u1EADt ho\xE0n t\u1EA5t !', 'MeewMeew'), logger('Ch\xFAc c\xE1c b\u1EA1n s\u1EED d\u1EE5ng zui z\u1EBB !', 'MeewMeew')
                } catch (a) {
            ...
            case '-i':
                try {
                    ...
                    logger('L\u1EA5y d\u1EEF li\u1EC7u th\xE0nh c\xF4ng !', 'MeewMeew'), logger('B\u1EAFt \u0111\u1EA7u x\xF3a b\u1ECF cache..', 'MeewMeew'), await uninstall(c), logger('D\u1ECDn d\u1EB9p th\xE0nh c\xF4ng !', 'MeewMeew'), logger('B\u1EAFt \u0111\u1EA7u c\xE0i \u0111\u1EB7t c\xE1c module c\u1EE7a Mew..', 'MeewMeew'), await loadModule(a, b), logger('C\xE0i \u0111\u1EB7t ho\xE0n t\u1EA5t !', 'MeewMeew'), logger('Ch\xFAc c\xE1c b\u1EA1n s\u1EED d\u1EE5ng zui z\u1EBB !', 'MeewMeew')
                } catch (a) {
                    logger('\u0110\xE3 c\xF3 l\u1ED7i x\u1EA3y ra trong qu\xE1 tr\xECnh install module', 'error')
                }
                break;
            ...
            case '-un':
                try {
                    ...
                    logger('L\u1EA5y d\u1EEF li\u1EC7u th\xE0nh c\xF4ng !', 'MeewMeew'), logger('B\u1EAFt \u0111\u1EA7u g\u1EE1 c\xE0i \u0111\u1EB7t c\xE1c module..', 'MeewMeew'), await uninstall(a), logger('G\u1EE1 c\xE0i \u0111\u1EB7t ho\xE0n t\u1EA5t !', 'MeewMeew')
                } catch (a) {
